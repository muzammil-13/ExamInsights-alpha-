from loguru import logger  # For enhanced logging
...
# --- Logging Setup ---
logger.add("exam_insight.log", rotation="500 MB")  # Configure log file
...
def internal_server_error(error):
    logger.exception("An error occurred:", error)  # Log the exception
